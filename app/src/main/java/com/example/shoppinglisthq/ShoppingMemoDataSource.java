...
public class ShoppingMemoDataSource {
    ...
    public void deleteShoppingMemo(ShoppingMemo shoppingMemo) {
        ...
        Log.d(TAG, "deleteShoppingMemo: Eintrag gelöscht! ID: "+ id + "Inhalt: "+ shoppingMemo.toString());
    }
    ...
    public void open() {
        Log.d(TAG, "Eine Referenz auf Datenbank wird angefragt.");
